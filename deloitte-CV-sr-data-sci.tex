...
\address{6114 Chancellor St}{Philadelphia, PA}{USA}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
...
\begin{document}
	...
	\recipient{Deloitte.}{Strategic Analytics}
	\date{\today }
...
%I am experienced with managing/mentoring small groups of people from different backgrounds and with various skillsets. %These collaborations have led to publications and the development of new statistical tools. 
