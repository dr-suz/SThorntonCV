...
\WorkExperience
    ...
    {Washington D.C.}  
    {
        ...
        \item Software: R, R Markdown, Stan, Python, vscode, terminal, git  
...
\WorkExperience
    ...
    {
        \item Methods/models:     
        \item Software: R, R Markdown, terminal, git  
        \item Platform: Mac
        \item Other: Published/implemented ethical stats training in introductory and advanced stats classes, Published in Philosophy of Science         
    } 
...
\WorkExperience
    ...
    {Swarthmore, PA}  
    {
        ...
        \item Platform: Mac  
        \item Other: Designed and taught successful hybrid statistics courses, implemented ethical stats training in introductory stats classes
        } 
...
\WorkExperience
    ...
    {New Brunswick, NJ}  
    {
        \item Methods/models: Predictive modeling,   
        \item Software: R 
...
\EducationExperience
    ...
    {\item Thesis: \href{    https://rucore.libraries.rutgers.edu/rutgers-lib/61966/}{Advanced computing methods for statistical inference} 
     \item Methods/models: Approximate Bayesian computing, confidence distribution inference, algorithmic development    
     %\begin{itemize}
     	\item Software: R, TeX  
     	\item Platform: Mac, Windows 
     	\item Other: Parallel computing, taught SAS course   
     %	\end{itemize} 
     \item Publication: \href{ https://pubmed.ncbi.nlm.nih.gov/30430540/ }{Exact inference on the random-effects model for meta-analyses with few studies} 
     %\begin{itemize}
     	\item Methods/models: Random effects, meta-analysis,    
     	\item Software: R, TeX
     	\item Platform: Mac
     %	\end{itemize} 
    }
